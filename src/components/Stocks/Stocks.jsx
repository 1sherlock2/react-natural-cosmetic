...
import './Stocks.scss';
import { AddProductForm } from '../Utils/Add_product_form/AddProductForm';
		...
		<div>
			...
			<div className="container-fluid">
				<div className="stock_container_info">
					{!props.product ? (
						<div>
							{props.isLoaded && !props.productForm ? (
								...
								<div>
									<div className="card card_elements" key={`${item.id} ${index}`}>
										...
										<div className="card-body">
													...
													<div>
														<div className="btn-group stocks_count">
															<div className="stocks_count_span">
																<button type="button" className="btn btn-secondary btn-secondary_1" onClick={() => props.decreaseCount()}>
																	-
																</button>
																<span>{props.count}</span>
																<button type="button" className="btn btn-secondary btn-secondary_2" onClick={() => props.increaseCount()}>
																	+
																</button>
															</div>
											...
											<button type="button" class="btn btn-primary btn-sm " onClick={() => props.addInBasket(item, props.count)}>
												Добавить в корзину
											</button>
										</div>
									</div>
